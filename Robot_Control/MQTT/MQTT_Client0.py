...
MQTT_ROBOT_TYPE = "Unitree-G1-Dex3"
MQTT_ROBOT_ID = "2A5PE-YUSHU008"
...
class MQTT_Client():
    def __init__(self, arm, mode="local", args=default_args):
        ...
        self.mode = mode
        self.ROBOT_UUID = args.get("id", MQTT_ROBOT_ID)
        self.ROBOT_TYPE = args.get("type", MQTT_ROBOT_TYPE)
