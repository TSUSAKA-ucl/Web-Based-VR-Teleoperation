...
def main():
    ...
    # canのインターフェース名はオプションで指定する。"-c"や"--can_port"で指定できるようにする。デフォルトは"can0"とする。
    parser.add_argument("--can_port", "-c", type=str, default="can0", help="CAN port for PiPER (default: can0)")
